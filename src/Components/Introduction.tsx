    ...
    return (
        <Container className="mx-auto">
            ...
            <p className="text-center">
                a bataille est un jeu de cartes qui se joue habituellement à deux qui est d'une grande simplicité pour les débutants, puisqu'on peut y jouer sous la conduite exclusive du hasard (bien que la manière dont sont rangés les plis peut influencer considérablement l'issue du jeu1, pour les joueurs avancés).
