    ...
    return (
        <Container className="mx-auto">
            ...
            <p className="text-center">
                La bataille est un jeu de cartes qui se joue habituellement à deux qui est d'une grande simplicité pour les débutants, puisqu'on peut y jouer sous la conduite exclusive du hasard (bien que la manière dont sont rangés les plis peut influencer considérablement l'issue du jeu1, pour les joueurs avancés).
                On distribue l'ensemble d'un (ou plusieurs) jeu de cartes (ici 32) aux joueurs, qui n'en prennent pas connaissance. À chaque tour, chaque joueur retourne la carte du haut de sa main (ou son tas). Celui qui a la carte de la plus haute valeur — selon la hiérarchie du bridge : as, roi, dame, valet, dix… jusqu'au deux — fait la levée, qu'il place sous son tas.
                ...
                Avec ces règles, il est possible de calculer le nombre moyen de plis nécessaires pour terminer une partie à deux joueurs. Une simulation numérique donne une moyenne de 480 plis et une médiane de 360 plis (avec 52 cartes). Un coup moyen durant typiquement 10 secondes, 50 % des parties durent 1 heure ou plus. Toujours par simulation numérique, on peut estimer à 90 % de chance de victoire pour une main initiale contenant les 4 as, et à 70 % de chance de victoire pour une main initiale n'en contenant que 3. L'avantage pour des mains contenant les quatre rois est bien plus faible car cela donne une probabilité de victoire de 56 % uniquement.
            </p>
            <br></br>
            ...
            <p className="text-center">
                Peut etre ya un truc la
            </p>
            <div className="text-center">
                <Button variant="outline-dark"> Commencer le Jeu</Button>
            </div>
        </Container>
